...
import (
	...
	// import "hacko-app/internal/pkg/validator"
...
type Adapter struct {
	...
	//Driven Adapters
	HackoPostgres *sqlx.DB
	Validator         Validator // *validator.Validator
	HackoStorage  *s3.Client
}
...
func (a *Adapter) Unsync() error {
	...
	if a.HackoPostgres != nil {
		if err := a.HackoPostgres.Close(); err != nil {
			errs = append(errs, err.Error())
		}
		log.Info().Msg("Hacko Postgres disconnected")
	}
