CREATE TABLE IF NOT EXISTS materials (
    ...
    users_classes_id INT NOT NULL, -- Kolom untuk ID user kelas, foreign key ke tabel `users_classes`
    ...
    FOREIGN KEY (users_classes_id) REFERENCES users_classes(id) ON DELETE CASCADE -- Foreign key ke tabel `users_classes`
