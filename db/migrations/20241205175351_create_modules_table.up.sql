CREATE TABLE IF NOT EXISTS modules (
    ...
    content VARCHAR(255) NOT NULL, -- Kolom untuk judul material
    attachments TEXT[] NOT NULL, -- Array string untuk lampiran
    videos TEXT[] NOT NULL, -- Array string untuk video
